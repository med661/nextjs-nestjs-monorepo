...
const trainingData: TrainingItem[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1627398242454-45a1465c2479?ixlib=rb-1.2.1&auto=format&fit=crop&w=1474&q=80",
    rating: 4.8,
    price: 49.99,
  },
  {
    ...
    location: "London, UK",
    image:
      "https://images.unsplash.com/photo-1561070791-2526d30994b5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80",
    rating: 4.6,
    price: 39.99,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80",
    rating: 4.9,
    price: 59.99,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80",
    rating: 4.7,
    price: 44.99,
  },
  {
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1605745341112-85968b19335b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1471&q=80",
    rating: 4.8,
    price: 49.99,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80",
    rating: 4.6,
    price: 39.99,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80",
    rating: 4.7,
    price: 34.99,
  },
  {
...
const Training: React.FC = () => {
  ...
  const categories = Array.from(
    new Set(trainingData.map((item) => item.category))
  );
  const levels = Array.from(new Set(trainingData.map((item) => item.level)));
  const durations = Array.from(
    new Set(trainingData.map((item) => item.duration))
  );
  const locations = Array.from(
    new Set(trainingData.map((item) => item.location))
  );
    ...
    <div className="flex-grow p-6 ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <button
            className="flex items-center text-[#0081C9] hover:text-[#0082C8] transition duration-150 ease-in-out"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              ...
              <div className="col-span-full mt-4">
                <button
                  ...
                  className="w-full bg-[#0081C9] text-white py-2 px-4 rounded-lg hover:bg-indigo-700 transition duration-150 ease-in-out"
                >
                  Apply Filters
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {paginatedData.map((item) => (
            <div
              key={item.id}
              className="bg-gray-50 rounded-lg shadow-md overflow-hidden transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="p-6">
                ...
                <p className="text-[#0081C9] font-medium mb-3">
                  {item.category}
                </p>
